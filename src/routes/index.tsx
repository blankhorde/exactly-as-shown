  ...
  return (
    <main className="min-h-screen bg-background">
      <div className="mx-auto w-full max-w-[390px] px-4 py-8">
        <h1 className="font-['Instrument_Serif'] text-[32px] leading-tight text-foreground">
          Lumen — the dark room
        </h1>
        <p className="mt-2 text-[14px] leading-relaxed text-muted-foreground">
          One world, three ways to place the board in it. Open each room to judge the light.
        </p>
          ...
          {THEMES.map((theme) => (
            ...
            >
              ...
              <div className="px-4 py-4">
                ...
                <span className="mt-3 inline-block text-[13px] font-semibold text-primary">
                  Enter this room →
                </span>
              </div>
            </Link>
